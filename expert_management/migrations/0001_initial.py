# Generated by Django 3.1.4 on 2021-01-21 07:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_subscribed_to_newsletter', models.BooleanField(default=False, verbose_name='Do you want to subscribe to Newsletter?')),
            ],
            options={
                'verbose_name': 'Expert',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', expert_management.models.MultiSelectField(base_field=models.CharField(choices=[('Coordination Office Staff', 'Coordination Office Staff'), ('Co-PI', 'Co-PI'), ('SLC-Member', 'SLC-Member')], max_length=512), blank=True, default=list, null=True, size=None)),
                ('co_pi_year', models.IntegerField(blank=True, null=True)),
                ('slc_year', models.IntegerField(blank=True, null=True)),
                ('working_group', expert_management.models.MultiSelectField(base_field=models.CharField(choices=[('Education for Sustainable Mountain Development', 'Education for Sustainable Mountain Development'), ('Elevation Dependent Climate Change', 'Elevation Dependent Climate Change'), ('Mountain Governance', 'Mountain Governance'), ('Mountain Observatories', 'Mountain Observatories'), ('Mountain Resilience', 'Mountain Resilience')], max_length=512), blank=True, default=list, null=True, size=None)),
                ('other_working_group', models.TextField(blank=True, null=True)),
                ('working_group_notes', models.TextField(blank=True, null=True)),
                ('involvement', expert_management.models.MultiSelectField(base_field=models.CharField(choices=[('Adaptation at Altitude', 'Adaptation at Altitude'), ('Global Assessment', 'Global Assessment'), ('Conéctate-A+', 'Conéctate-A+'), ('Contribution to IPCC AR6', 'Contribution to IPCC AR6'), ('GEO Mountains', 'GEO Mountains'), ('Synthesis Workshops', 'Synthesis Workshops')], max_length=512), blank=True, default=list, null=True, size=None)),
                ('other_involvement', models.TextField(blank=True, null=True)),
                ('involvement_notes', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', expert_management.models.MultiSelectField(base_field=models.CharField(choices=[('Data Provider', 'Data Provider'), ('Data user', 'Data user'), ('Lead or Co-Lead', 'Lead or Co-Lead'), ('Observatory Contact Point', 'Observatory Contact Point'), ('Staff member of the Secretariat to the Flagship or Initiative', 'Staff member of the Secretariat to the Flagship or Initiative'), ('Steering Committee (Board, Advisory Ctte, etc) Member)', 'Steering Committee (Board, Advisory Ctte, etc) Member)')], max_length=512), blank=True, default=list, null=True, size=None)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
