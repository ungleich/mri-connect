# Generated by Django 3.1.3 on 2020-11-09 15:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('funding', models.CharField(blank=True, max_length=256, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=256)),
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='people.topic')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_email', models.CharField(blank=True, max_length=256, null=True, unique=True)),
                ...
                ('disciplines', models.ManyToManyField(blank=True, help_text='Disciplinary expertise topics', related_name='experts', to='people.Topic')),
                ('expertise', models.ManyToManyField(blank=True, help_text='Research expertise', related_name='experts', to='people.Expertise')),
                ('projects', models.ManyToManyField(blank=True, related_name='experts', to='people.Project')),
            ],
            options={
                'verbose_name': 'Person',
